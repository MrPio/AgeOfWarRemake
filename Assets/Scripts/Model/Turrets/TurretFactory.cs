...
namespace Model.Bases
{
    public static class TurretFactory
    {
        ...
        public static Turrets.Turret Chicken() => new(damage: 1, range: 3, bulletSpeed: 1f, cost: 150, sellPrice: 75,
            name: "Chicken", "turret_1_2");

        public static Turrets.Turret Catapult() => new(damage: 5, range: 5, bulletSpeed:2.5f, cost: 500, sellPrice: 250,
